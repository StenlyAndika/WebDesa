<section class="col-md-3 section page-title right-panel">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold">KEPALA DESA</h6>
        </div>
        <div class="card-body">
            <?php if(count($instansi)<=0) : ?>
                <div  class="img-fluid img-responsive center-block"><img style="object-fit: cover; height: 370px; width: 250px;" src="<?= base_url('./assets/img/avatar.png') ?>" alt="img"></div>
                <h5 style="font-size: 14px;" class="ccz font-weight-bold mt-4">NAMA</h5>
            <?php else: ?>
                <?php if($instansi[0]['fotokepala'] == null) : ?>
                    <div  class="img-fluid img-responsive center-block"><img style="object-fit: cover; height: 370px; width: 250px;" src="<?= base_url('./assets/img/avatar.png') ?>" alt="img"></div>
                <?php else : ?>
                    <div  class="img-fluid img-responsive center-block"><img style="object-fit: cover; height: 370px; width: 250px;" src="<?= base_url('./upload/fotokepala/').$instansi[0]['fotokepala'] ?>" alt="img"></div>
                <?php endif; ?>
